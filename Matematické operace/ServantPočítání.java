...
/*******************************************************************************
 * Instance třídy {@code ServantPočítání} představují ...
 * The {@code ServantPočítání} class instances represent ...
 *
 * @author  author name
 * @version 0.00.0000 — 20yy-mm-dd
 */
public class ServantPočítání
{
...
//\II== CONSTRUCTORS AND FACTORY METHODS =======================================
    ...
    /***************************************************************************
     */
    public ServantPočítání()
    {
    }

    public void počítej(IPočítání operace, double x, double y)
    {
        double vysledek = operace.počítej(x, y);
